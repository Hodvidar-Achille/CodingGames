...
/**
 * https://www.codingame.com/ide/puzzle/chuck-norris by Hodvidar
 **/
class ChuckNorris {
	...
	public static void main(final String[] args) {
		...
		final byte[] byteLettresMessage = MESSAGE.getBytes();
		int i = 0;
		...
		for (final byte b : byteLettresMessage) {
			i = b;
		...
		final char[] binaire2 = binaire.toCharArray();
