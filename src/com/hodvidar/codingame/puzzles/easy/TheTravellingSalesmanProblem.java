...
class TheTravellingSalesmanProblem {
    ...
    private void test() {
        ...
        do {
            ...
            for (int j = 0; j < N; j++) {
                ...
                double distance = n2.getDistance(n1.p, n2.p);
    ...
    class Node {
        ...
        public String toString() {
            String point = "point:" + ((this.p == null) ? "@null" : this.p);
            String position = "n°" + this.position;
            String previous = "previous:" + ((this.previous == null) ? "@null" : this.previous.p);
            String next = "next:" + ((this.next == null) ? "@null" : this.next.p);
            String distToNext = "distance to next:" + this.distanceToNext;
