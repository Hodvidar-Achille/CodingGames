...
{	
	...
	class Interval implements Comparable<Interval>
	{
		...
		public Interval(double min, double max, SpeedCalculator speedCalculator)
		{
			this.min = min;
			this.max = max;
	...
	class SpeedCalculator
	{
		...
		// ---- Converting methods ----
		public double getSpeedInMeterPerSecond(int speedInKmPerHour)
		{
			// * (5/18)
			return roundForAneonTest(((speedInKmPerHour) / 3.6d));
		}

		public int getSpeedInKmPerHour(double speedInMeterPersecond)
		{
			// * (18 / 5)
			return (int) roundForAneonTest((speedInMeterPersecond) * 3.6d);
		}

		public double getSpeedInMeterPerHour(int speedInKmPerHour)
		{
			// * 10000
			return speedInKmPerHour * 1000.0;
		}

		public double getSpeedInKmPerHour(int speedInMeterPerHour)
		{
			// / by 3600 seconds
		...
		public double roundByConvertingIntoInteger(double number)
		{
			int n = (int) number;
			return n;
		}

		public double roundForAneonTest(double x)
		{
