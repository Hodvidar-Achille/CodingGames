...
public final class _Day17 {
    ...
    public static void main(final String[] args) throws Exception {
        final String result = test(RESOURCES + File.separator + INPUT_DIRECTORY + File.separator + "input"
                + NUMBER_OF_TEST + ".txt");
        System.err.println("Expected '10064' - result='" + result + "'");
    }
    ...
    private static String subTest(final String inputFile) throws Exception {
        ...
        final int result = robot.calculateCameraCalibration();
        robot.printPanels();
        System.out.println("NonEmpty panels:" + robot.getNumberOfNonEmpty());
        return "" + result;
    }
