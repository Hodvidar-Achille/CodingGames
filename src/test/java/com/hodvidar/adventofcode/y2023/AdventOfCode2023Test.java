...
class AdventOfCode2023Test {
    ...
    @Test
    void getCalibrationValue_1() {
        Assertions.assertThat(AdventOfCode2023.getCalibrationValue(getCalibrationValue_inputTest.split("\n")))
                .isEqualTo(142.0);
    }

    @Test
    void getCalibrationValue_2() {
        Assertions.assertThat(AdventOfCode2023.getCalibrationValue(getCalibrationValue_inputReal.split("\n")))
                .isEqualTo(54597);
    }

    // ############################ VARIABLES ##########################
    private static final String getCalibrationValue_inputTest = "1abc2\n" +
            "pqr3stu8vwx\n" +
            "a1b2c3d4e5f\n" +
            "treb7uchet";

    private static final String getCalibrationValue_inputReal = "9sixsevenz3\n" +
